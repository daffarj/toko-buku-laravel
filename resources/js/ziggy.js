const Ziggy = {
    ...
    routes: {
        ...
        payment: { uri: "payment", methods: ["GET", "HEAD"] },
        "payment.confirm": { uri: "payment\/confirm", methods: ["POST"] },
        "payment.code": { uri: "payment\/code", methods: ["GET", "HEAD"] },
        "payment.verify": { uri: "payment\/verify", methods: ["POST"] },
        "payment.success": {
            uri: "payment\/success",
            methods: ["GET", "HEAD"],
        },
        "payment.failed": { uri: "payment\/failed", methods: ["GET", "HEAD"] },
        "order.confirmation": {
